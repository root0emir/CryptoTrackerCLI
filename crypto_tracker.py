...
class CryptoTracker:
    def __init__(self):
        ...
        self.currencies = ["bitcoin", "ethereum", "binancecoin", "solana", "ripple", 
                           "cardano", "polkadot", "dogecoin", "avalanche-2", "tron"]
    ...
    def display_data(self, data):
        ...
        print(f"\n{Fore.MAGENTA}Top 10 Cryptocurrencies by Market Cap{Style.RESET_ALL}")
